...
annotate service.Incidents with @(
    ...
    UI.Facets : [
        ...
        },
        {
            ...
            Label : '{i18n>Comments}',
            ID : 'i18nComments',
            Target : 'comments/@UI.LineItem#i18nComments2',
        },
    ],
    UI.LineItem : [
        {
...
annotate service.Comments with @(
    ...
    UI.LineItem #i18nComments1 : [
        {
            $Type : 'UI.DataField',
            Value : incident.comments.author,
        },
        {
            $Type : 'UI.DataField',
            Value : incident.comments.comment,
            Label : 'comment',
        },
        {
            $Type : 'UI.DataField',
            Value : incident.comments.timestamp,
        },
    ],
    UI.LineItem #i18nComments2 : [
        {
            $Type : 'UI.DataField',
            Value : author,
            Label : '{i18n>Author}',
